...
const FriendDetails = () => {
    ...
    return (
        <div className='flex justify-center items-center p-10'>
            <div className='grid grid-cols-3 gap-10 w-[80%] my-7'>
                <div className='space-y-5 col-span-1'>
                    <div className='rounded-lg space-y-2.5 py-3 px-2 flex flex-col justify-center items-center shadow-[0px_0px_10px_10px_rgba(244,244,244,1)]'>
                        ...
                        <p className='text-[#64748b] text-base italic w-[80%] text-center font-medium'>"{friend.bio}"</p>
                ...
                <div className='col-span-2 space-y-7 h-full flex flex-col justify-between'>
                    <div className='flex flex-1 gap-5'>
                        <div className='flex-1 rounded-lg text-center py-6 px-2 shadow-[0px_0px_8px_5px_rgba(244,244,244,1)]'>
                            <h3 className='text-3xl font-semibold text-[#244d3f] mb-1'>{friend.days_since_contact}</h3>
                            <p className='text-[#64748b]'>Days Since Contact</p>
                        </div>
                        <div className='flex-1 rounded-lg text-center py-6 px-2 shadow-[0px_0px_8px_5px_rgba(244,244,244,1)]'>
                            <h3 className='text-3xl font-semibold text-[#244d3f] mb-1'>{friend.goal}</h3>
                            <p className='text-[#64748b]'>Goals (Days)</p>
                        </div>
                        <div className='flex-1 rounded-lg text-center py-6 px-2 shadow-[0px_0px_8px_5px_rgba(244,244,244,1)]'>
                            <h3 className='text-3xl font-semibold text-[#244d3f] mb-1'>{printDate(friend.next_due_date)}</h3>
